...
public class LottoUI {
    ...
    /**
      ...
      * lotto numbers and variables min and max determinates 
      * lottoNumbersPoolSize which is the size of the numberspool.
      * 
    ...
    public static void main(String [] args) {
        ...
        // Determinates the numberspool size.
        int min = 1;
        int max = 40;

        // The size of the numberspool where the right numbers are chosen from.
        int lottoNumbersPoolSize = max - min + 1;
